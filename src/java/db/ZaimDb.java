...
public class ZaimDb
{
  ...
  {
    Token_zaim token = (Token_zaim)this.em.find(Token_zaim.class, session.getAttribute("user_id").toString());
  ...
  {
    return (Token_zaim)this.em.find(Token_zaim.class, userId);
  }
